const { ALL_DORMS, getDemoGrabOrders } = require('../../utils/campusData.js');
  ...
  loadPendingOrders() {
    wx.cloud.callFunction({
      ...
      fail: () => {
        this.setData({
          pendingOrders: [
            { _id: '1', orderId: 'ORD001', fromDorm: '中园公寓', fromRoom: '302', toDorm: '苏园居', toRoom: '201', deliveryFee: 5, createTime: '10分钟前' }
          ]
        });
      }
    });
