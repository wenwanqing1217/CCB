...
Page({
  ...
  onLoad() {
    ...
    // 监听全局事件
    this.app = getApp()
    this.app.on('loginSuccess', this.onLoginSuccess.bind(this))
  },
  ...
  useMockData() {
    const mockBoxes = [
      { _id: '1', title: '全新数码配件盲盒', price: 9.9, images: ['https://images.unsplash.com/photo-1526304640581-d334cdbbf45e?w=600'], fromDorm: '东区', sales: 23, type: 'secondhand', typeName: '二手数码盲盒', isHot: true },
      { _id: '2', title: '精美文具套装', price: 14.9, images: ['https://images.unsplash.com/photo-1524661135-423995f22d0b?w=600'], fromDorm: '西区', sales: 45, type: 'creative', typeName: '创意盲盒' },
      { _id: '3', title: '时尚服饰盲盒', price: 19.9, images: ['https://images.unsplash.com/photo-1551632436-cbf8dd35adfa?w=600'], fromDorm: '南区', sales: 12, type: 'fashion', typeName: '时尚盲盒' },
      { _id: '4', title: '图书盲盒', price: 12.9, images: ['https://images.unsplash.com/photo-1544947950-fa07a98d237f?w=600'], fromDorm: '北区', sales: 34, type: 'book', typeName: '图书盲盒' },
      { _id: '5', title: '运动装备盲盒', price: 29.9, images: ['https://images.unsplash.com/photo-1517836357463-d25dfeac3438?w=600'], fromDorm: '中区', sales: 18, type: 'sports', typeName: '运动盲盒', isNew: true },
      { _id: '6', title: '校园生活盲盒', price: 19.9, images: ['https://images.unsplash.com/photo-1523050854058-8df90110c9f1?w=600'], fromDorm: '东区', sales: 56, type: 'life', typeName: '生活盲盒' }
    ]
    this.setData({
      boxes: mockBoxes,
      loading: false,
  ...
  useMockGrabOrders() {
    this.setData({
      grabOrders: [
        { _id: '1', fromDorm: '东区', toDorm: '西区', fee: 1 },
        { _id: '2', fromDorm: '西区', toDorm: '南区', fee: 1 }
      ],
      pendingOrders: 2
    })
  },
